...
export const App = () => {
  const [selectedItem, setSelectedItem] = createSignal<ContentProps>(knowledgeData as ContentProps);
  ...
  return (
    <div class="dark flex divide-x  min-h-screen">
      ...
      <div class="w-3/5 pl-5 py-5 bg-dark-800 overflow-auto text-gray-300">
